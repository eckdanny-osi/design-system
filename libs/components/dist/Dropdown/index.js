...
import { UncontrolledDropdown as RSUncontrolledDropdown, DropdownToggle as RSDropdownToggle, DropdownMenu as RSDropdownMenu, DropdownItem as RSDropdownItem } from 'reactstrap';
export const UncontrolledDropdown = withCssModule(RSUncontrolledDropdown, styles); // export { RSDropdownToggle as DropdownToggle };
