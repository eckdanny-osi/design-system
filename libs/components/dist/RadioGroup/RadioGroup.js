...
export default class RadioGroup extends React.Component {
  ...
  render() {
    return React.createElement(React.Fragment, null, React.createElement("fieldset", null, this.props.legend && React.createElement(Legend, {
      required: true
    }, this.props.legend), this.props.options.map(this.renderOption)), this.props.error && this.props.renderError(this.props.error));
  }
